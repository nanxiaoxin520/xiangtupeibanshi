...
本文件说明如何在各 AI 平台安装 xiangtupeiubanshi Skill。
...
# 3. 验证安装
ls "C:/Users/wu'xin/npm-global/node_modules/@deepseek-ai/dsh/skills/xiangtupeiubanshi/SKILL.md"

# 4. 在 DSH 对话中使用
# 输入 $xiangtupeiubanshi 启用 Skill
```
...
```
~/.claude/skills/xiangtupeiubanshi/
├── SKILL.md
├── agents/
│   └── openai.yaml
├── guides/
...
在 Claude Code 对话中输入 `@xiangtupeiubanshi` 启用。
...
```
~/.codex/skills/xiangtupeiubanshi/
├── SKILL.md
├── agents/
│   └── openai.yaml
├── guides/
...
在 Codex 对话中输入 `$xiangtupeiubanshi` 启用。
...
1. 输入 `$xiangtupeiubanshi` 或 `@xiangtupeiubanshi`
...
```bash
# DSH
rm -rf "C:/Users/wu'xin/npm-global/node_modules/@deepseek-ai/dsh/skills/xiangtupeiubanshi/"

# Claude Code
rm -rf ~/.claude/skills/xiangtupeiubanshi/

# Codex
rm -rf ~/.codex/skills/xiangtupeiubanshi/
```
